...
export const schemaDict = {
  ...
  AppWarlogJournal: {
    lexicon: 1,
    id: 'app.warlog.journal',
    defs: {
      main: {
        type: 'record',
        description:
          'A journal entry documenting incidents, symptoms, or experiences for targeted individuals.',
        key: 'tid',
        record: {
          type: 'object',
          required: ['text', 'entryType', 'createdAt'],
          properties: {
            text: {
              type: 'string',
            ...
            location: {
              type: 'ref',
              ref: 'lex:app.warlog.journal#geoLocation',
              description: 'Geographic location where the incident occurred.',
            },
            symptoms: {
              type: 'array',
              description: 'Structured symptom classifications.',
              items: {
                type: 'ref',
                ref: 'lex:app.warlog.journal#symptom',
              },
              maxLength: 20,
            },
            evidenceUris: {
            ...
            isPrivate: {
              ...
              default: true,
              description:
                'Whether this entry should be private to the author.',
            },
            createdAt: {
              type: 'string',
              format: 'datetime',
      ...
      geoLocation: {
        ...
        properties: {
          latitude: {
            type: 'string',
            description: 'Latitude coordinate as string to preserve precision.',
          },
          longitude: {
            type: 'string',
            description:
              'Longitude coordinate as string to preserve precision.',
          },
          accuracy: {
            type: 'integer',
      ...
      symptom: {
        type: 'object',
        description: 'A structured symptom entry.',
        ...
        properties: {
          category: {
            ...
            description: 'Symptom category classification.',
          },
          subcategory: {
            type: 'string',
            maxLength: 100,
            description: 'More specific symptom description.',
          },
          severity: {
            type: 'integer',
            minimum: 1,
            maximum: 10,
            description: 'Severity scale from 1 (mild) to 10 (severe).',
          },
          duration: {
            type: 'string',
            maxLength: 100,
            description:
              "Duration of the symptom (e.g., '30 minutes', 'ongoing').",
          },
          notes: {
            type: 'string',
            maxLength: 500,
